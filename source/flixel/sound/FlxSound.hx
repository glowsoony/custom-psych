...
class FlxSound extends FlxBasic {
	...
	function updateTransform():Void {
		_transform.volume = #if FLX_SOUND_SYSTEM (FlxG.sound.muted ? 0 : 1) * FlxG.sound.volume * #end 1 * _volume * _volumeAdjust;
	...
	{
		if (time == _time) return _time = time;
